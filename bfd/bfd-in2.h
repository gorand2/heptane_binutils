...
#define bfd_mach_visium        1
  bfd_arch_heptane,    /* Heptane */
#define bfd_mach_heptane       1 /* att 64 bit */
  bfd_arch_last
  };
...
/* heptane/elf relocations  */
  BFD_RELOC_HEPTANE_GOT32,
  BFD_RELOC_HEPTANE_PLT32,
  BFD_RELOC_HEPTANE_COPY,
  BFD_RELOC_HEPTANE_GLOB_DAT,
  BFD_RELOC_HEPTANE_JUMP_SLOT,
  BFD_RELOC_HEPTANE_RELATIVE,
  BFD_RELOC_HEPTANE_GOTPCREL,
  BFD_RELOC_HEPTANE_32S,
  BFD_RELOC_HEPTANE_DTPMOD64,
  BFD_RELOC_HEPTANE_DTPOFF64,
  BFD_RELOC_HEPTANE_TPOFF64,
  ...
  BFD_RELOC_HEPTANE_GOTPC32,
  BFD_RELOC_HEPTANE_GOT64,
  BFD_RELOC_HEPTANE_GOTPCREL64,
  BFD_RELOC_HEPTANE_GOTPC64,
  BFD_RELOC_HEPTANE_GOTPLT64,
  BFD_RELOC_HEPTANE_PLTOFF64,
  BFD_RELOC_HEPTANE_GOTPC32_TLSDESC,
  BFD_RELOC_HEPTANE_TLSDESC_CALL,
  BFD_RELOC_HEPTANE_TLSDESC,
  BFD_RELOC_HEPTANE_IRELATIVE,
  BFD_RELOC_HEPTANE_PC32_S1,
  BFD_RELOC_HEPTANE_PLT32_S1,
  BFD_RELOC_HEPTANE_GOTPCRELX,
  BFD_RELOC_HEPTANE_REX_GOTPCRELX,
