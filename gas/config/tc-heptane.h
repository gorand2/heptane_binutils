...
#include "opcodes/heptane-opc.h"

struct fix;

#define TARGET_BYTES_BIG_ENDIAN	0
#define STORE_LAST_FRAG_SIZE
#define STORE_FRAG_EXPR

#define TARGET_ARCH		(heptane_arch ())
#define TARGET_MACH		(heptane_mach ())
extern enum bfd_architecture heptane_arch (void);
extern unsigned long heptane_mach (void);

#ifdef TE_FreeBSD
#define AOUT_TARGET_FORMAT	"a.out-heptane-freebsd"
#endif
#ifdef TE_NetBSD
#define AOUT_TARGET_FORMAT	"a.out-heptane-netbsd"
#endif
#ifdef TE_386BSD
#define AOUT_TARGET_FORMAT	"a.out-heptane-bsd"
#endif
#ifdef TE_LINUX
#define AOUT_TARGET_FORMAT	"a.out-heptane-linux"
#endif
#ifdef TE_Mach
#define AOUT_TARGET_FORMAT	"a.out-mach3"
#endif
#ifdef TE_DYNIX
#define AOUT_TARGET_FORMAT	"a.out-heptane-dynix"
#endif
#ifndef AOUT_TARGET_FORMAT
#define AOUT_TARGET_FORMAT	"a.out-heptane"
#endif

#ifdef TE_FreeBSD
#define ELF_TARGET_FORMAT	"elf32-heptane-freebsd"
#define ELF_TARGET_FORMAT64	"elf64-heptane-freebsd"
#elif defined (TE_VXWORKS)
#define ELF_TARGET_FORMAT	"elf32-heptane-vxworks"
#elif defined (TE_NACL)
#define ELF_TARGET_FORMAT	"elf32-heptane-nacl"
#define ELF_TARGET_FORMAT32	"elf32-heptane-nacl"
#define ELF_TARGET_FORMAT64	"elf64-heptane-nacl"
#endif

#ifdef TE_SOLARIS
#define ELF_TARGET_FORMAT	"elf32-heptane-sol2"
#define ELF_TARGET_FORMAT64	"elf64-heptane-sol2"
#endif

#ifndef ELF_TARGET_FORMAT
#define ELF_TARGET_FORMAT	"elf32-heptane"
#endif

#ifndef ELF_TARGET_FORMAT64
#define ELF_TARGET_FORMAT64	"elf64-heptane"
#endif

#ifndef ELF_TARGET_FORMAT32
#define ELF_TARGET_FORMAT32	"elf32-heptane"
#endif
...
extern const char *heptane_target_format (void);
#define TARGET_FORMAT heptane_target_format ()
#else
#ifdef TE_GO32
...
extern operatorT heptane_operator (const char *name, unsigned int operands, char *);
#define md_operator heptane_operator

extern int heptane_need_index_operator (void);
#define md_need_index_operator heptane_need_index_operator

#define md_register_arithmetic 0

#define md_relax_frag(segment, fragp, stretch) \
  heptane_relax_frag (segment, fragp, stretch)
extern int heptane_relax_frag (asection *, struct frag *, long);


extern int optimize_align_code;

extern void heptane_label(void);
...
extern void heptane_align_code (fragS *, int);

#define HANDLE_ALIGN(fragP)						\
if (fragP->fr_type == rs_align_code) 					\
  heptane_align_code (fragP, (fragP->fr_next->fr_address			\
			   - fragP->fr_address				\
			   - fragP->fr_fix));
...
#define TC_START_LABEL(STR, NUL_CHAR, NEXT_CHAR) (heptane_label(), \
  NEXT_CHAR == ':')
